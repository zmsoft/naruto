 ...
 *
 * *****    copy from listviewanimtions arrayadapter    *********
 */
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements Swappable, Insertable<T> {
    ...
    //每一次添加进来的值
    private @NonNull  Collection<? extends T> collection;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		//FIXME For example, here is a listview pageIndex
		if(position+1==mItems.size()){
			if(collection.size()>20){
				//TODO return new FooterView();
			}else{
				//TODO return new EndView();
			}
		}
		return getData(position, convertView, parent);
	}
	public abstract View getData(int arg0, View arg1, ViewGroup arg2);
}
