 ...
 * you must call {@link #setup(android.content.Context, FragmentManager, int)} to complete the
...
public class FragmentTabHost extends TabHost implements
	 ...
	 *             {@link #setup(android.content.Context, FragmentManager)} or
	...
	public Fragment getCurrentTabFragment() {
		return getCurrentTabFragment(getCurrentTabTag());
	}

	public Fragment getCurrentTabFragment(String tag) {
